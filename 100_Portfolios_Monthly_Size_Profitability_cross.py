...
with open('output/fama_french/100_Portfolios_Monthly_Size_Profitability_cross.txt','w') as file:
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1963/07', '2016/12'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1963/07', '1973/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1973/08', '1983/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1983/07', '1993/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1993/07', '2003/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '2003/07', '2013/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1963/07', '1983/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1983/07', '2003/06'), N, T, f = file, Factors = ['Mkt-RF', 'SMB', 'RMW'])