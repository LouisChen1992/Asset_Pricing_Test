...
with open('output/fama_french/100_Portfolios_Monthly_cross.txt', 'w') as file:
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1978/07', '1999/06'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1973/01', '2016/10'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1973/01', '1982/12'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1983/01', '1992/12'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1993/01', '2002/12'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '2003/01', '2012/12'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1973/01', '1992/12'), N, T, file)
	...
	q, T = F.shape
	N = Y.shape[0]
	display_cross(result_cross(F, Y, T, N, q), ('Monthly', '1993/01', '2012/12'), N, T, file)